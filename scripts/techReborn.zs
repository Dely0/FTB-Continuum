...
mods.actuallyadditions.Empowerer.addRecipe(<techreborn:part:29>, <techreborn:plates:34>, <appliedenergistics2:material:5>, <minecraft:redstone>, <thermalfoundation:material:128>, <minecraft:gold_ingot>, 5000, 100);
